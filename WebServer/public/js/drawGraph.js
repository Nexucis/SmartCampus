...
function drawGraphTP(objElem) {
    ...
    var lastDate = {
        ...
        day : new Date(lastData[0][0]).getDay(),
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'Graphe de la température du capteur'
        },
        subtitle: {
        ...
        series: [{
            ...
            pointStart: Date.UTC(lastDate.year, lastDate.month, lastDate.day+9, lastDate.hour, lastDate.minutes, lastDate.seconds),
            data: lastData
        }]
    });
}