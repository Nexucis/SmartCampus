...
def ReadSerie():
        try:
                ...
                #If there is a problem during the serial connection
                time = datetime.datetime.now()
...
#Print and chose a serial port

print("List of serial ports : ")
print(serial_ports())
serialPort = input("Please enter the serial port where your device is connected : ")
...
try:
        ...
        #If there is a problem during the connection
        time = datetime.datetime.now()
